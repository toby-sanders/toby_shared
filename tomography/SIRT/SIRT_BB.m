...
a1 = bb;
tic;
fprintf('Running SIRT...');
for i = 1:iter
    % gradient decent!! d1 and d2 are for normalization
    g = W'*a1;
    ...
    if constraint, x = max(x,minc); end
    if maxconstraint, x = min(x,maxc); end
